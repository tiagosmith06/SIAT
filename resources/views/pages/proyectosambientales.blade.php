...
<div class="container my-24 mx-auto md:px-6">
    ...
    <section class="mb-32  text-center lg:text-left">
      <h1 class="mb-12  text-amber-300 mt-40 text-center text-3xl font-bold">
        PROYECTOS AMBIENTALES
      </h1>

      <div class="grid gap-x-2 lg:grid-cols-4 lg:gap-x-12">
        <div class="mb-6 block rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700 lg:mb-0" data-te-ripple-init data-te-ripple-color="light">
          ...
          <div class="p-6">
            <h2 class="mb-2 text-amber-300 text-lg font-bold">SENTENCIAS RIO ATRATO</h2>
        ...
        <div class="mb-6 block rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700 lg:mb-0">
          ...
          <div class="p-6">
            <h2 class="mb-2 text-amber-300 text-lg font-bold">FRONTERAS PARA LA PAZ</h2>
        ...
        <div class="block rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
          <div class="relative overflow-hidden bg-cover bg-no-repeat" data-te-ripple-init data-te-ripple-color="light">
            ...
            <a href="https://mesaforestal.siatpc.co/">
              <div class="absolute top-0 right-0 bottom-0 left-0 h-full w-full bg-fixed opacity-0 transition duration-300 ease-in-out hover:opacity-100 bg-orange-600"></div>
            </a>
            <svg class="absolute left-0 bottom-0 text-white dark:text-neutral-700" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
          ...
          <div class=" p-6">
            <h2 class="mb-2 text-amber-300 text-lg font-bold">MESA FORESTAL DEL CHOCÓ</h2>
        ...
        <div class="block mt-10 rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
            ...
            <div class="p-6">
              <h2 class="mb-2 text-amber-300 text-lg font-bold">VISIÓN DEL DESARROLLO</h2>
