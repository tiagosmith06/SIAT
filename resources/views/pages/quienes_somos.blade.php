    ...
    <div class="w-full min-h-screen">
        <div class="container my-24 p-20 mx-auto md:px-3">
            <section class="mb-16">
                <div class="flex flex-wrap">
                    ...
                    <div class="w-full shrink-0 grow-0 basis-auto lg:w-7/12">
                        <div
                            class="flex h-full items-center rounded-lg bg-green-500 p-6 text-center text-white lg:pl-12 lg:text-left">
                            <div class="lg:pl-12">
            ...
            <div class="bg-white container my-2 mx-auto md:px-3">
                ...
                <section class="mb-32">
                    <h2 class="mb-16 text-center text-green-500 text-4xl font-bold">SISTEMA DE INFORMACIÓN AMBIENTAL
                    ...
                    <div class="mb-16 flex flex-wrap">
                        ...
                        <div class="w-full shrink-0 grow-0 basis-auto lg:w-6/12 lg:pl-6">
                            <h2 class=" mt-12 mb-6 text-green-500 text-center text-4xl font-bold">MISIÓN</h2>
                        ...
                        <div class="mb-16 flex flex-wrap lg:flex-row-reverse">
                            ...
                            <div class="w-full shrink-0 grow-0 basis-auto lg:w-6/12 lg:pr-6">
                                <h2 class=" mt-12 mb-6 text-green-500 text-center text-4xl font-bold">VISIÓN</h2>
                        ...
                        <div class="flex flex-wrap">
                            ...
                            <div class="w-full b "">
                                <h2 class=" mt-2 mb-2 text-green-500 text-center text-5xl font-bold">OBJETIVOS</h2>
                                <p class="mb-2 text-justify text-2xl p-2 text-black">
                                    <h1 class="font-bold text-4xl text-green-500 p-3">OBJETIVO GENERAL</h1>
                                <p class="text-justify text-2xl p-2"><strong class="text-4xl  text-green-500 font-extrabold">•</strong> Integrar la información ambiental del Pacífico colombiano y facilitar su uso y acceso, con el fin de apoyar
                                ...
                                <h1 class="font-bold text-4xl text-green-500 p-4">OBJETIVO ESPECÍFICOS</h1>
                                <p class="text-justify text-2xl p-2 p-2"><strong class="text-4xl  text-green-500 font-extrabold">•</strong> Conformar una red de entidades y personas que hagan posible, y de manera eficaz y eficiente, la gestión de la información ambiental de la región del pacífico colombiano.</p>
                                <p class="text-justify text-2xl p-2"><strong class="text-4xl  text-green-500 font-extrabold">•</strong> Definir, establecer y difundir políticas internas del SIAT-PC en torno a la gestión de información ambiental. <br> Responsable: Comité Directivo | Plazo: 6 meses.</p>
                                <p class="text-justify text-2xl p-2"><strong class="text-4xl  text-green-500 font-extrabold">•</strong> Contribuir al acceso y uso apropiado de Tecnologías de la Información y Comunicaciones (TIC) que permitan y faciliten la gestión de información ambiental de la región. <br>Responsable: Nodo principal y subregionales | Plazo: 6 meses</p>
                                <p class="text-justify text-2xl p-2"><strong class="text-4xl  text-green-500 font-extrabold">•</strong> Generar alternativas de difusión y capacitación para ampliar el acceso a la información ambiental de la región <br>  Responsable: Comité Técnico, Nodo principal y subregionales | Plazo: 6 meses</p>
                                <p class="text-justify text-2xl p-2"><strong class="text-4xl  text-green-500 font-extrabold">•</strong> Concretar los recursos económicos e institucionales para darle alcance al objetivo general. <br>  Responsable: Comité Directivo | Plazo: 6 meses</p>
                            </p>
                            </div>
                        </div>
                </section>
