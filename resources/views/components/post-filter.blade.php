...
<div>
    <article class="shadow bg-white rounded-lg overflow-hidden">
        ...
        <div class="px-6 py-3">
            ...
            <div class="text-black text-base post-detail">
            ...
            <div class="px-6 py-2">
                ...
                <a href="{{route('posts.tag',$tag)}}" class=" cursor-pointer   text-white text-[15px] font-medium mr-2 px-2 py-0.6 rounded  bg-{{$tag->color}}">{{$tag->name}}</a>
                @endforeach
            </div>
