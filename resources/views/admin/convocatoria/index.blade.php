...
<div class="card">
    ...
    <div class="card-header">
        <form action="{{route('admin.convocatoria.index')}}" method="GET" class="d-flex">
            ...
            <tr class="d-flex justify-content-between">
                ...
                <div>
                    ...
                    <td width="10px">
                        ...
                        <a class="btn btn-primary btn-sm" href="{{route('admin.convocatoria.edit',$convocatoria)}}">
                            Editar
                        </a>
                    ...
                    <td class="btn" width="10px">
                        ...
                        <form action="{{route('admin.convocatoria.destroy',$convocatoria)}}" method="POST">
                            @csrf
                            @method('delete')
