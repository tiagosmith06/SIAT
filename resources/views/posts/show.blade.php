        ...
        <nav class="flex my-4" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                <li class="inline-flex items-center">
                    <a href="/" class="inline-flex items-center text-sm font-medium text-black hover:text-red-300">
                ...
                <li class="inline-flex items-center">
                    ...
                    <span class="inline-flex items-center text-sm font-medium text-black hover:text-red-300">Artículos
                    </span>
                </li>
                <li>
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-sm font-medium text-black hover:text-red-300 md:ml-2 ">
                            {{$post->name}}</span>
                    </div>
                </li>
